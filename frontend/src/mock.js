// Mock data for Mael Goualard's portfolio - placeholder content (to be replaced)
...
export const stats = [
  { value: "2025", label: "Promotion" },
  { value: "BUT TC", label: "Formation" },
  { value: "Castres", label: "Campus" },
